...
void BSP_MOTOR_demo(void)
{
	...
	//d�claration des moteurs, et initialisation des broches/p�riph�riques correspondants.
	right_motor_id = BSP_MOTOR_add(GPIOA, GPIO_PIN_12, GPIOB, GPIO_PIN_6);	//le choix des broches est strat�giques : elles doivent correspondre � des TIMERS !
